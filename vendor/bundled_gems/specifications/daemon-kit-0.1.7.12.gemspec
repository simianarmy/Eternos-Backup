...
To get started quickly run 'daemon-kit' without any arguments
  ...
  s.test_files = ["spec/abstract_logger_spec.rb", "spec/argument_spec.rb", "spec/config_spec.rb", "spec/configurable_spec.rb", "spec/daemon_kit_spec.rb", "spec/error_handlers_spec.rb", "spec/initializer_spec.rb", "spec/spec_helper.rb", "test/test_amqp_generator.rb", "test/test_cron_generator.rb", "test/test_daemon-kit_generator.rb", "test/test_daemon_kit_config.rb", "test/test_deploy_capistrano_generator.rb", "test/test_generator_helper.rb", "test/test_helper.rb", "test/test_jabber_generator.rb", "test/test_nanite_agent_generator.rb", "test/test_ruote_generator.rb", "test/test_test_unit_generator.rb"]
